...
public class GenerateRandomMcQuestionComSentences : MonoBehaviour
{
    ...
    public static GenerateRandomMcQuestionComSentences instance;
    ...
    async void ShowSavedDatabasePanel()
    {
        ...
        McQuestionQuiz currentResult = await DbHelper.GetEngP3CompleteSentencesResultById(userId);
        ...
        if (currentResult == null)
        {
            ...
            bool success = await DbHelper.AddNewEngP3CompleteSentencesResult(userId, correctCount, totalQuestion, myTime, (canAttemptTimes-1));
        ...
        else
        {
            if (currentResult.attemptLeft > 0)
            {
                ...
                if (correctCount > currentResult.correctCount)
                {
                    ...
                    bool updateCorrectCountSuccess = await DbHelper.UpdateEngP3CompleteSentencesCorrectCount(userId, correctCount);
