...
public class GenerateRandomMcQuestionChineseIdiom2 : MonoBehaviour
{
    ...
    public static GenerateRandomMcQuestionChineseIdiom2 instance;
    ...
    async void ShowSavedDatabasePanel()
    {
        ...
        McQuestionQuiz currentResult = await DbHelper.GetChineseP3Idiom2ResultById(userId);
        ...
        if (currentResult == null)
        {
            ...
            bool success = await DbHelper.AddNewChineseP3Idiom2Result(userId, correctCount, totalQuestion, myTime, canAttemptTimes);
        ...
        else
        {
            if (currentResult.attemptLeft > 0)
            {
                ...
                if (correctCount > currentResult.correctCount)
                {
                    ...
                    bool updateCorrectCountSuccess = await DbHelper.UpdateChineseP3Idiom2CorrectCount(userId, correctCount);
                    bool updateTimesSuccess = await DbHelper.UpdateChineseP3Idiom2Times(userId, myTime);
                    bool updateAttempTimesSuccess = await DbHelper.UpdateChineseP3Idiom2Attempt(userId, newAttempt);
