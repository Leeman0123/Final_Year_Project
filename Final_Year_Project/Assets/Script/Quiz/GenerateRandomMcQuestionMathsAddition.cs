...
public class GenerateRandomMcQuestionMathsAddition : MonoBehaviour
{
    ...
    public static GenerateRandomMcQuestionMathsAddition instance;
    ...
    async void ShowSavedDatabasePanel()
    {
        ...
        McQuestionQuiz currentResult = await DbHelper.GetMathsP1AdditionResultById(userId);
        ...
        if (currentResult == null)
        {
            ...
            bool success = await DbHelper.AddNewMathsP1Additionesult(userId, correctCount, totalQuestion, myTime, canAttemptTimes);
        ...
        else
        {
            if (currentResult.attemptLeft > 0)
            {
                ...
                if (correctCount > currentResult.correctCount)
                {
                    ...
                    bool updateCorrectCountSuccess = await DbHelper.UpdateMathsP1AdditionCorrectCount(userId, correctCount);
                    bool updateTimesSuccess = await DbHelper.UpdateMathsP1AdditionTimes(userId, myTime);
                    bool updateAttempTimesSuccess = await DbHelper.UpdateMathsP1AdditionAttempt(userId, newAttempt);
                ...
                } else
                {
                    ...
                    attemptText.text = $"The quiz result will be saved, and you have {currentResultAttemptLeft} times chance";
                    bool updateAttempTimesSuccess = await DbHelper.UpdateMathsP1AdditionTimes(userId, newAttempt);
