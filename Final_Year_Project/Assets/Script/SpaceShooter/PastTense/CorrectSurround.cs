...
public class CorrectSurround : MonoBehaviour
{
    AudioSource playaudio;
    public AudioClip audioClip;
    public GameObject explo;

    public static CorrectSurround instance;
    ...
    void Start()
    {
        ...
        canshoot = false;
        if (!textchange) {
            transform.GetComponentInChildren<Canvas>().GetComponentInChildren<Text>().text = JSONReader.instance.GetPastSimpleWrong();
        }
    }
