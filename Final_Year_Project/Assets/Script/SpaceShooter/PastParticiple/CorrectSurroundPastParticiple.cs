...
public class CorrectSurroundPastParticiple : MonoBehaviour
{
    AudioSource playaudio;
    public AudioClip audioClip;
    public GameObject explo;

    public static CorrectSurroundPastParticiple instance;
    ...
    void Start()
    {
        ...
        canshoot = false;
        if (!textchange) {
            transform.GetComponentInChildren<Canvas>().GetComponentInChildren<Text>().text = JSONReader.instance.GetPastParticipleWrong();
        }
    }
